class Human {
  ...
  void setaddress(String address){
    this.address= address; // we can modify the needed one through getter and setter
...
Sangam.setaddress("Salyan");
 Sangam.ShowhumanDetails();
 Sangam.getaddress();// get the  modified address
 print(Sangam.getaddress());// displays the get address
// 
}
